  ...
  return (
    <div className="bg-white rounded-xl  border -mt-4 border-zinc-200 p-3.5 w-3xl">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="relative shrink-0">
            <div className="w-26 h-26 rounded-[14px] bg-zinc-100 border border-zinc-200 overflow-hidden">
              <Image
                src={displayPicture}
                alt="Hitesh Suthar"
      ...
      <div className="flex gap-2 mt-3.5">
        <button className="px-4 flex items-center justify-center gap-1.5 bg-zinc-900 text-white text-[12px] font-medium py-2 rounded-[10px]">
        ...
        >
          <button className=" cursor-pointer flex px-3 items-center justify-center gap-1.5 bg-white border border-zinc-200 text-zinc-600 text-[12px] font-medium py-2 rounded-[10px]">
            <svg
              width="14"
              height="15"
              viewBox="0 0 27 26"
      ...
      {/* Status bar */}
      <div className="mt-2.5 bg-zinc-100 rounded-[10px] px-3 py-2 flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          <div className="w-1.5 h-1.5 rounded-full bg-green-500" />
          <span className="text-[11px] text-zinc-600">Building @Fypped</span>
        </div>
