...
const Footer = ({ cn = " -x" }) => {
  ...
  return (
    <div className=" -b w-full   -900  ">
      <div
        className={`max-w-2xl p-3 relative gap-3 flex justify-between items-center  w-full mx-auto   -900    ${cn}`}
      >
        <div className="w-2 h-2 bg-white dark:bg-black    -800 -bottom-1 -left-1 absolute  "></div>
        <div className="w-2 h-2 bg-white  dark:bg-black    -800 -bottom-1 -right-1 absolute  "></div>
        <div>
