...
const Page = async ({ params }: Props) => {
  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center font-sans dark:bg-[#09090B] mt-2">
      {/* Block */}
      <div className="w-full  -t z-0 items-center justify-center flex    -900">
      ...
      <div className="w-full relative  -b  -t font-mono tracking-tight  -900  ">
        <div className="mx-auto gap-1  flex flex-col max-w-2xl  -x  -900      relative">
          ...
          <div className="p-2 items-center flex gap-2 mt-2">
            <Link href={"/projects"}>
              <div className="text-neutral-700 w-fit hover:dark:bg-neutral-900 hover: -800 rounded-md    -transparent hover:  hover:bg-neutral-50">
          ...
          {/* Video Block */}
          <div className="h-70   m-2 rounded-lg p-2    -800">
          ...
          <div className="p-4 -mt-1 font-sans    -900 items-center justify-center flex ">
      ...
      <div className="w-full  -b z-0 items-center justify-center flex    -900">
        <div className="max-w-2xl w-full relative mx-auto">
          <div className="dotted-background w-full h-[12.5rem] flex items-center justify-center p-12"></div>
        </div>
      </div>
...
const Badge = ({ name, icon }: { name: string; icon: React.ReactNode }) => (
  <div className="inline-flex  items-center gap-1.5 px-3 py-1 rounded-md    -dashed    -700 bg-white dark:bg-neutral-900 text-neutral-700 dark:text-neutral-300 text-sm font-medium hover: -neutral-400 dark:hover: -neutral-500 transition-colors cursor-default select-none whitespace-nowrap">
